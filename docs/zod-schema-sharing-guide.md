...
> **Recommended**: For parent-child relationships, prefer nested schema references over ID-based foreign keys. See the [Scaffold Guide](./scaffold-guide.md#nested-schema-references) for details.
